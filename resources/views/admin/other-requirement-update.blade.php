            ...
            <div class="col-xl-6 col-lg-6">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Update Other Requirement</h6>
                    ...
                    <!-- Card Body -->
                    <div class="card-body">
                        <form action="/other_requirement/update/{{ $otherRequirement->id }}" method="post" enctype="multipart/form-data"
                            id="formTambahData">
                            @csrf
                            <div class="form-group">
                                <label for="nama">Type Name</label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="nama" name="name" value="{{ $otherRequirement->name }}">
                                @error('name')
